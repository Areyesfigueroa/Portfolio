...
const zipPageProject = {
    ...
    longDesc: "Allows for the brokerage team to manage MLS zip codes. I added the ability to import zip codes as a CSV file. However, the brokerage team can add or edit the imported zip codes before committing them to the database. Once added, the zip codes can still be edited by clicking on the cell. Saving zip code data is integrated with other business logic within the HomeListed codebase.",
    techDesc: [
